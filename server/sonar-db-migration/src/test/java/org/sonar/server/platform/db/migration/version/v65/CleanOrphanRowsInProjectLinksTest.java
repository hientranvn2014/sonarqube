...
public class CleanOrphanRowsInProjectLinksTest {
  ...
  @Test
  public void execute_remove_row_from_project_links_which_component_is_not_a_project() throws SQLException {
    long link1 = insertProjectLink(insertComponent(SCOPE_PROJECT, QUALIFIER_PROJECT));
    long link2 = insertProjectLink(insertComponent(SCOPE_PROJECT, QUALIFIER_VIEW));
    insertProjectLink(insertComponent(randomAlphabetic(3), QUALIFIER_PROJECT));
    insertProjectLink(insertComponent(randomAlphabetic(3), QUALIFIER_VIEW));
    insertProjectLink(insertComponent(SCOPE_PROJECT, randomAlphabetic(3)));
  ...
  public void execute_removes_row_from_project_links_which_component_does_not_exist() throws SQLException {
    String projectUuid = insertComponent(SCOPE_PROJECT, QUALIFIER_PROJECT);
